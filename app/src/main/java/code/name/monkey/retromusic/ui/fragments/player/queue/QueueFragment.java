package code.name.monkey.retromusic.ui.fragments.player.queue;
...
public class QueueFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks {
  ...
  private QueuePlaybackControlsFragment playbackControlsFragment;
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    View view = inflater.inflate(R.layout.fragment_queue_player, container, false);
  ...
  private void setUpSubFragments() {
    playbackControlsFragment =
        (QueuePlaybackControlsFragment) getChildFragmentManager()

...
import static code.name.monkey.retromusic.util.Util.createBitmap;
                        ...
                        .into(new SimpleTarget<BitmapPaletteWrapper>(bigNotificationImageSize,
                            ...
                            private void setNotificationContent(boolean dark) {
                                ...
                                Bitmap close = createBitmap(
                                        Util.getTintedVectorDrawable(service, R.drawable.ic_close_white_24dp, primary),
                                        1.3f);
                                ...
                                Bitmap next = createBitmap(
                                        Util.getTintedVectorDrawable(service, R.drawable.ic_skip_next_white_24dp,
                                                primary), 1.3f);
                                Bitmap playPause = createBitmap(Util.getTintedVectorDrawable(service,
                                ...
                                notificationLayout.setImageViewBitmap(R.id.smallIcon,
                                        createBitmap(Util.getTintedVectorDrawable(service, R.drawable.ic_notification, secondary), 0.6f));

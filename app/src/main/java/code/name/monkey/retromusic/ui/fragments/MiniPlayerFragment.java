...
public class MiniPlayerFragment extends AbsMusicServiceFragment implements
  ...
  private void setUpMiniPlayer() {
    ...
    if (PreferenceUtil.getInstance(getContext()).getAdaptiveColor()) {
      progressBar
          .setProgressTintList(ColorStateList.valueOf(ThemeStore.accentColor(getActivity())));
    } else {
      progressBar.setProgressDrawable(
          ContextCompat.getDrawable(getContext(), R.drawable.mini_player_progress_drawable));
    }
  }

...
public class ThemeSettingsFragment extends AbsSettingsFragment {
  ...
  public void invalidateSettings() {
    ...
    primaryColorPref.setVisible(PreferenceUtil.getInstance(getActivity()).getGeneralTheme()
        == R.style.Theme_RetroMusic_Color);
    ...
    generalTheme.setOnPreferenceChangeListener((preference, newValue) -> {
      ...
      switch (theme) {
        ...
        case "black":
          ...
          break;
        case "dark":
          ThemeStore.editTheme(getContext()).primaryColor(
              ContextCompat.getColor(getContext(), R.color.md_grey_900)).commit();
          break;
        case "color":
          ThemeStore.editTheme(getContext()).primaryColor(
              ContextCompat.getColor(getContext(), R.color.md_blue_grey_800)).commit();
          break;
        case "acolor":
          ThemeStore.editTheme(getContext()).primaryColor(Color.BLACK).commit();
          break;

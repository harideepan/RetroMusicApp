...
public class VolumeFragment extends Fragment implements SeekBar.OnSeekBarChangeListener,
  ...
  public void onAudioVolumeChanged(int currentVolume, int maxVolume) {
    ...
    volumeDown.setImageResource(currentVolume == 0 ? R.drawable.ic_volume_off_white_24dp
  ...
  public void setProgressBarColor(int newColor) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      volumeSeekbar
          .setSecondaryProgressTintList(ColorStateList.valueOf(ColorUtil.darkenColor(newColor)));
    } else {
